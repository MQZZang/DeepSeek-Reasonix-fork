...
export default function App() {
  ...
  const handleSend = useCallback(
    ...
    [applyGoal, closeTransientOverlays, collaborationMode, composerProfile, goal, goalStatus, send, runShell, notice, setControllerCollaborationMode, setControllerGoal, setControllerToolApprovalMode, steer, switchModel, t, toolApprovalMode, showToast],
  );
