...
export const zh: Record<DictKey, string> = {
  ...
  "composer.modeAgent": "智能体",
  "composer.modeAgentDesc": "以完整智能体能力执行任务。",
  "composer.modeMenuTitle": "模式",
  "composer.permissionMenuTitle": "权限（Ctrl/Cmd+Y 切换 Yolo）",
  ...
  "composer.goalPaused": "已暂停",
  "composer.goalPausedDesc": "已暂停 — /goal resume 继续",
  "composer.goalBlocked": "受阻",
  "composer.goalBlockedDesc": "受阻 — 解除阻塞后 /goal resume 继续",
  "composer.tokenEconomy": "省 token",
  "composer.tokenModeFull": "标准",
  "composer.tokenModeFullDesc": "加载完整工具与技能索引。",
  ...
  "composer.collabAsk": "问答",
  "composer.collabAskDesc": "只回答问题，不改动仓库。",
  "composer.enterCollabAskTitle": "进入问答模式（shift+tab）—— 只读、只答不改",
  "composer.exitCollabAskTitle": "退出问答模式（shift+tab）",
  "composer.modeHint": "shift+tab",
  "composer.modeTitle": "协作菜单；shift+tab 循环计划与问答；ctrl/cmd+y 切换 Yolo",
