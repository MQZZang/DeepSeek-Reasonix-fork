...
export const en = {
  ...
  "composer.modeAgentDesc": "Execute tasks with full agent capabilities.",
  "composer.modeMenuTitle": "Mode",
  "composer.permissionMenuTitle": "Permissions (Ctrl/Cmd+Y toggles Yolo)",
  ...
  "composer.goalPaused": "Paused",
  "composer.goalPausedDesc": "Paused — /goal resume to continue",
  "composer.goalBlocked": "Blocked",
  "composer.goalBlockedDesc": "Blocked — /goal resume after you unblock it",
  "composer.tokenEconomy": "token saver",
  "composer.tokenModeFull": "standard",
  "composer.tokenModeFullDesc": "Load the full tools and skill index up front.",
  ...
  "composer.collabAsk": "Q&A",
  "composer.collabAskDesc": "Answer questions without modifying the repo.",
  "composer.enterCollabAskTitle": "Enter Q&A mode (shift+tab) — read-only answers only",
  "composer.exitCollabAskTitle": "Exit Q&A mode (shift+tab)",
  "composer.modeHint": "shift+tab",
  "composer.modeTitle": "Collaboration menu; shift+tab cycles plan and Q&A; ctrl/cmd+y toggles YOLO",
