...
export function StatusBar({
  ...
  const modeIndicators = [
    ...
    askMode ? <span className="statusbar__ask" key="ask">{t("status.collabAsk")}</span> : null,
    goalMode && !goalPaused && !goalBlocked ? <span className="statusbar__plan" key="goal">{t("composer.goalMode")}</span> : null,
    goalPaused ? <span className="statusbar__goal-paused" key="goal-paused">{t("status.goalPaused")}</span> : null,
    goalBlocked ? <span className="statusbar__goal-blocked" key="goal-blocked">{t("status.goalBlocked")}</span> : null,
