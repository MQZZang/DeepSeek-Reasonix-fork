...
var English = Messages{
	...
	ChatStatusCycleHint:         "shift+tab cycles plan/ask · ctrl+y yolo",
	ChatStatusCacheNowFmt:       "turn hit %s",
	ChatStatusCacheAvgFmt:       "avg %s",
	ChatStatusPlanApproval:      "Enter/y approves & executes · e requests changes · n/Esc keeps planning · PgUp/PgDn/Ctrl+Home/End scrolls",
	PlanApprovalPrompt:          "Plan ready above — Enter/y to approve & execute, e to request changes, n/Esc to keep planning",
	PlanFeedbackPrompt:          "Describe the changes you want to the plan — Enter sends it back for revision, Esc returns",
	PlanFeedbackSentFmt:         "↳ revision requested: %s",
	...
	CmdGoal:         "set, pause/resume, or clear the active goal",
	CmdAsk:          "ask mode: answer-only, repo untouched (/ask off to leave)",
	...
	GoalCurrentStatusFmt:   "goal (%s): %s",
	GoalSetFmt:             "goal set → %s",
	GoalCleared:            "goal cleared",
	GoalPaused:             "goal paused — /goal resume to continue",
	GoalNothingToPause:     "goal: nothing running to pause",
	GoalNothingToResume:    "goal: nothing paused to resume",
	GoalResumedFmt:         "goal resumed → %s",
	GoalPausedMarkerless:   "goal paused: two replies in a row missing the [goal:*] status marker — /goal resume to continue",
	GoalRestoredFmt:        "goal restored (paused): %s — /goal resume to continue",
	AskModeOn:              "ask mode on — answers only, the repo stays untouched; /ask off to leave",
	AskModeOff:             "ask mode off",
	PlanArtifactSavedFmt:   "plan saved to %s",
	PlanNudgeDeclined:      "the reply was not submitted as a plan — ask for the plan to be submitted to raise the approval gate",
