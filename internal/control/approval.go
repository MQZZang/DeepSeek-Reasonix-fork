...
type approvalManager struct {
	...
	// planToolWaiver, when set, narrows planAutoApprove to previewable writers.
	planToolWaiver func(string) bool
...
func (a *approvalManager) planAutoApproveActive() bool {
	a.mu.Lock()
	defer a.mu.Unlock()
	return a.planAutoApprove
}

func (a *approvalManager) setPlanToolWaiver(fn func(string) bool) {
	a.mu.Lock()
	a.planToolWaiver = fn
	a.mu.Unlock()
}
...
func (a *approvalManager) bypassAllowsLocked(tool string) bool {
	...
	if a.planAutoApprove {
		return a.planToolWaiver == nil || a.planToolWaiver(tool)
	}
	return false
}
